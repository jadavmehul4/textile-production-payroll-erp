...
impl StealthEngine {
    ...
    pub unsafe fn overlap_execution() {
        core::arch::asm!(
            ...
            "2: .byte 0xEB",
            "3: call 2b",
            // This creates a complex flow for disassemblers
        );
    }

    /// Monitors the CR3 register for unexpected changes.
    ...
    /// Triggers the "Cloak" mechanism (wiping registers).
    pub fn trigger_cloak() {
        unsafe {
            core::arch::asm!(
                "xor rax, rax", "xor rbx, rbx", "xor rcx, rcx", "xor rdx, rdx",
                "xor rsi, rsi", "xor rdi, rdi", "xor r8, r8", "xor r9, r9",
                "xor r10, r10", "xor r11, r11", "xor r12, r12", "xor r13, r13",
